...
A Go library and CLI tool for decoding and encoding audio files across multiple formats. audiomorph provides a unified interface for reading audio data from WAV, AIFF, MP3, OGG, and FLAC files, and encoding to WAV, AIFF, and MP3 formats.
...
// Encode audio to file (supports WAV, AIFF, MP3)
